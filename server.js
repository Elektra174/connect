...
const CLIENT_DATABASE = {
    ...
    c5: { id: "c5", name: "Анна", age: 25, profession: "Студентка", gender: "female", bio: "Не может завершить разрушительные отношения. Боится одиночества до ватных ног." },
    ...
    c14: { id: "c14", name: "Павел", age: 22, profession: "Курьер", gender: "male", bio: "Зависимость от мнения родителей в 22 года. Не может принять решение." },
